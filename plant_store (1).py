...
def render_chatbot_sidebar():
    ...
    /* FAB button that sits bottom-right to open sidebar */
    .leaflife-fab-hint {
        position: fixed;
        bottom: 28px;
        right: 28px;
        ...
        pointer-events: none; /* visual only — Streamlit button below handles click */
    }
    @keyframes fabPulse {
    ...
    /* Override Streamlit sidebar toggle arrow */
    ...
    # ── Floating FAB hint (visual only — Streamlit can't inject true fixed buttons) ──
    st.markdown("""

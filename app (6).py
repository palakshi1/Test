...
def main():
    ...
    # ── Chatbot toggle FAB (bottom-right) ──
    if not st.session_state.chatbot_open:
        st.markdown("""
        <div class="leaflife-fab-hint">
            <span style="font-size:18px;">&#127807;</span>
            LeafLife Care
            <div class="fab-dot"></div>
        </div>
        """, unsafe_allow_html=True)
        # Actual clickable button positioned at bottom right via CSS
        st.markdown("""
        <style>
        div[data-testid="stVerticalBlock"] > div:has(> div[data-testid="stButton"] > button[kind="secondary"][id*="open_chatbot_fab"]) {
        ...
        button[kind="secondary"][id*="open_chatbot_fab"] {
            background: linear-gradient(135deg, #E91E8C, #AD1457) !important;
            color: white !important;
            border-radius: 50px !important;
    ...
    if st.session_state.chatbot_open:
        # Split layout: main content left, chatbot right
        ...
        with col_main:
            if page == "home":
                ...
                render_home()
        with col_chat:
            st.markdown('''<div style="border-left:1px solid #E8EDE8;min-height:100vh;background:#FAFAF7;padding:0;">''', unsafe_allow_html=True)
